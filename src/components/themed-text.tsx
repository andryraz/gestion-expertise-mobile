...
const COLOR_CLASSES: Record<ThemeColor, string> = {
  ...
  backgroundElement:
    "text-background-element dark:text-background-element-dark",
  backgroundSelected:
    "text-background-selected dark:text-background-selected-dark",
  ...
  const codeStyle =
    type === "code"
      ? {
          ...
          fontWeight: (Platform.select({ android: 700 }) ??
