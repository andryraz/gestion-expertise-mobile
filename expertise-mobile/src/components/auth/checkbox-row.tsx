    ...
    <Pressable
      ...
      <View
        className={[
          ...
          checked ? 'border-text dark:border-text-dark bg-text dark:bg-text-dark' : 'border-border dark:border-border-dark bg-transparent',
        ].join(' ')}>
        {checked && (
          <SymbolView
      ...
      <ThemedText type="small" themeColor="textSecondary" className="flex-1 leading-[19px]">
        {children}
      </ThemedText>
    </Pressable>
  );
